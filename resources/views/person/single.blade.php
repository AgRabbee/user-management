                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card mb-4">
                        <h5 class="card-header">
                            {{ $person->name }} |
                            User ID: <strong>{{ $person->user_id ?? 'Not set' }}</strong>
                        </h5>

                        <div class="divider my-0"><div class="divider-text"><i class="mdi mdi-star-outline"></i></div></div>

                        <div class="card-body">
                            <form method="POST" action="{{ route('person.update', \App\Libraries\Encryption::encodeId($person->id)) }}">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id"
                                                       value="{{ old('user_id', $person['user_id']) }}"/>
                                                @else
                                                    <p class="form-control bg-secondary-subtle" readonly>{{ $person['user_id'] }}</p>
                                                @endif
                                                @error('user_id')
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="f_name" name="father_name"
                                                       value="{{ ($person['father_is_dead']) ? 'Late ' : '' }}{{ $person['father_name'] }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-6 col-sm-12 md:text-end float-end">
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i
                                                        class="mdi mdi-account-outline"></i></span>
                                                <input type="text" class="form-control" id="m_name" name="mother_name"
                                                       value="{{ ($person['mother_is_dead']) ? 'Late ' : '' }}{{ $person['mother_name']}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-6 col-sm-12">
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            @php
                                                $contacts = explode(',',$person['contact_no']);
                                            @endphp
                                            @foreach($contacts as $contact_index=>$contact)
                                            <div class="input-group input-group-merge {{ $contact_index > 0 ? 'mt-1' : '' }}">
                                                <span id="contact" class="input-group-text"><i class="mdi mdi-phone"></i></span>
                                                    <input type="text" id="contact_no" name="contact_no[{{ $contact_index }}]" value="{{ $contact }}"
                                    ...
                                    <div class="row col-md-6 col-sm-12 md:text-end float-end">
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i
                                                        class="mdi mdi-calendar-blank-outline"></i></span>
                                ...
                                <div class="divider"><div class="divider-text"><i class="mdi mdi-minus"></i></div></div>

                                {{-- present & permanent address --}}
                                <div class="row">
                                    {{-- present address --}}
                                    <div class="row col-md-6 col-sm-12">
                                        <label class="col-sm-3 col-form-label" for="present_address">Present
                                            Address</label>
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                {{--<span class="input-group-text"><i class="mdi mdi-map-marker-outline"></i></span>--}}
                                                <textarea id="present_address" name="present_address" class="form-control">{{ $person['present_address'] }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {{-- Permanent Address --}}
                                    <div class="row col-md-6 col-sm-12 md:text-end float-end">
                                        <label class="col-sm-3 col-form-label" for="permanent_address">Permanent
                                            Address</label>
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                {{--<span class="input-group-text"><i class="mdi mdi-map-marker-outline"></i></span>--}}
                                                <textarea id="permanent_address" name="permanent_address" class="form-control">{{ $person['permanent_address'] }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <select id="blood_group" name="blood_group" class="form-select">
                                                    ...
                                                    @foreach($blood_groups as $group)
                                                        <option value="{{ strtolower($group) }}"
                                                            {{ strtolower($person['blood_group']) == strtolower($group) ? 'selected' : '' }}>
                                    ...
                                    {{-- marital status --}}
                                    <div class="row col-md-6 col-sm-12">
                                        <label class="col-sm-3 col-form-label" for="marital_status">Marital
                                            Status</label>
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                <select id="marital_status" name="marital_status" class="form-select">
                                                    ...
                                                    @foreach($marital_statuses as $statusIndex => $status)
                                                        <option value="{{ $statusIndex }}"
                                                            {{ $person['marital_status'] == $statusIndex ? 'selected' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row col-md-6 col-sm-12">
                                            ...
                                            <div class="col-sm-8" style="padding-left: 10px; padding-right: 2px;">
                                                <div class="input-group input-group-merge">
                                                    <span class="input-group-text"><i class="mdi mdi-identifier"></i></span>
                                                    <input type="text" class="form-control" id="spouse_user_id" name="spouse_user_id"
                                                           value="{{ $person['spouse_user_id'] }}"/>
                                                </div>
                                                <div class="form-text text-danger" id="srch_text" style="display: none;">
                                                    Searching ...
                                                </div>
                                            </div>

                                            <button type="button" id="user_id_srch"
                                            ...
                                            <div class="col-sm-9" style="padding-left: 10px;">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="spouse_name" readonly
                                                           value="{{ ($person->spouse) ? $person->spouse->name : 'N/A' }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="divider"><div class="divider-text">Family</div></div>
                                            ...
                                            <div class="input-group input-group-merge mt-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input head_of_family_inp" type="radio" name="is_head_of_family"
                                                           {{ $person['is_head_of_family'] == 1 ? 'checked' : '' }} id="yes" value="1"/>
                                                    <label class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input head_of_family_inp" type="radio" name="is_head_of_family"
                                                           {{ $person['is_head_of_family'] == 0 ? 'checked' : '' }} id="no" value="0"/>
                                ...
                                <div class="row" id="family_head_area" style="display: none;">
                                    ...
                                    <div class="row col-md-6 col-sm-12">
                                        ...
                                        <div class="col-sm-8" style="padding-left: 10px; padding-right: 2px;">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i class="mdi mdi-identifier"></i></span>
                                                <input type="text" class="form-control" id="family_head_user_id"
                                                       name="family_head_user_id"
                                                       value="{{ $person['family_head_user_id'] }}"/>
                                            </div>
                                            <div class="form-text text-danger" id="head_srch_text" style="display: none;">
                                                Searching ...
                                            </div>
                                        </div>
                                        <button type="button" id="head_user_id_srch"
                                                class="btn rounded-pill btn-icon btn-outline-primary">
                                            <span class="tf-icons mdi mdi-account-search-outline"></span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="row col-md-6 col-sm-12">
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i
                                                        class="mdi mdi-account-outline"></i></span>
                                                <input type="text" class="form-control" id="family_head" readonly
                                                       value="{{ ($person->headOfFamily) ? $person->headOfFamily->name : 'N/A' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="divider"><div class="divider-text">Academy Info</div></div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="degree_name" name="degree_name"
                                                       value="{{ !empty($person['academic_info']['degree_name']) ? $person['academic_info']['degree_name'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="subject_name" name="subject_name"
                                                       value="{{ !empty($person['academic_info']['subject_name']) ? $person['academic_info']['subject_name'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="institution_name" name="institution_name"
                                                       value="{{ !empty($person['academic_info']['institution_name']) ? $person['academic_info']['institution_name'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="institution_address" name="institution_address"
                                                       value="{{ !empty($person['academic_info']['institution_address']) ? $person['academic_info']['institution_address'] : ''
                                                       }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="passing_year" name="passing_year"
                                                       value="{{ !empty($person['academic_info']['passing_year']) ? $person['academic_info']['passing_year'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="divider"><div class="divider-text">Professional Info</div></div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="profession" name="profession"
                                                       value="{{ !empty($person['professional_info']['profession']) ? $person['professional_info']['profession'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="job_title" name="job_title"
                                                       value="{{ !empty($person['professional_info']['job_title']) ? $person['professional_info']['job_title'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="company_name" name="company_name"
                                                       value="{{ !empty($person['professional_info']['company_name']) ? $person['professional_info']['company_name'] : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9" style="padding-left: 10px;">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="company_address" name="company_address"
                                                       value="{{ !empty($person['professional_info']['company_address']) ? $person['professional_info']['company_address'] : ''
                                                       }}"/>
                                            </div>
                                        </div>
                                    </div>
...
@push('admin_custom_scripts')
    <script>
        $(document).ready(function () {
            ...
            @if($person['is_head_of_family'] == 0)
                $('.head_of_family_inp').trigger('change');
            @endif
            ...
            @if($person['do_wasiyyat'] == 1)
                $('.do_wasiyyat').trigger('change');
            @endif
            /* wasiyyat radio ends */
            ...
            @if($person['is_waqf_e_nou'] == 1)
                $('.is_waqf_e_nou_inp').trigger('change');
            @endif
            ...
            @if($person['type_of_person'] == 2)
                $('.type_of_person_inp').trigger('change');
            @endif
            ...
            @if($person['subscriber_of_pakkhik'] == 1)
                $('.subscriber_of_pakkhik').trigger('change');
            @endif
